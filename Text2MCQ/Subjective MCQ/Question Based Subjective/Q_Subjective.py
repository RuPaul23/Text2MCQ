...
question_starters = ["When", "What", "How"]

with open("mcq_with_matched_answers_objective.txt", "w") as mcq_file:
    for iterator in range(1, num_questions + 1):
        ...
        # Generate questions starting with "When," "What," or "How"
        question_starter = random.choice(question_starters)
        full_question = f"{question_starter} {question}"
        
        mcq_file.write(f"Question {iterator} -> {full_question}\n")
...
print(f"{num_questions} MCQs generated with matched answers, random distractors, and objective questions have been saved to mcq_with_matched_answers_objective.txt")
